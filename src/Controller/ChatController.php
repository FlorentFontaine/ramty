...
class ChatController extends AbstractController
{
    ...
    {
        return $this->render('pages/chat/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('pages/chat/new.html.twig', [
            'chat' => $chat,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('pages/chat/show.html.twig', [
            'chat' => $chat,
        ]);
    }
    ...
    public function edit(Request $request, Chat $chat, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('pages/chat/edit.html.twig', [
            'chat' => $chat,
            'form' => $form,
        ]);
    }

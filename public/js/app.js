...
(function () {
	...
	function initLeftMenuCollapse() {
		...
		if (
			...
			document.getElementById("two-column-menu") ? document.getElementById("two-column-menu").innerHTML = "" : "";
			if (document.querySelector(".navbar-menu")) {
				document.querySelector(".navbar-menu").innerHTML = navbarMenuHTML;
			}
	...
	function initActiveMenu() {
		...
		if (currentPath) {
			// navbar-nav
			var a = document
				.getElementById("navbar-nav") ? document.getElementById("navbar-nav").querySelector('[href="' + currentPath + '"]') : null;
			if (a) {
				a.classList.add("active");
				var parentCollapseDiv = a.closest(".collapse.menu-dropdown");
				if (parentCollapseDiv) {
					...
					if (elem.querySelectorAll(".notification-item").length > 0) {
						...
						if (!emptyNotificationElem) {
							...
							<div class="text-center pb-5 mt-2">\
								<h6 class="fs-18 fw-semibold lh-base">Hey ! Vous n\'avez pas de notifications  </h6>\
							</div>\
						</div>';
						}
					}

...
var idField = document.getElementById("tasksId"),
    projectNameField = document.getElementById("title-field"),
    assignedtoNameField = 'Ramty', //document.getElementById("assignedtoName-field"),
...
document.getElementById("showModal").addEventListener("show.bs.modal", function (e) {
    if (e.relatedTarget.classList.contains("edit-item-btn")) {
        ...
        document.getElementById("exampleModalLabel").innerHTML = "Créer un événement";
        document.getElementById("showModal").querySelector(".modal-footer").style.display = "block";
        document.getElementById("add-btn").innerHTML = "Ajouter";
    } else {

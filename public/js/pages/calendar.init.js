...
document.addEventListener("DOMContentLoaded", function () {
    //flatPickrInit();
    var addEvent = new bootstrap.Modal(document.querySelector('.event-modal'), {
        keyboard: false
    });
    ...
    function addNewEvent(info) {
        ...
        formEvent.reset();
        selectedEvent = null;
        modalTitle.innerText = 'Ajouter un événement';
        newEventData = info;
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function (info) {
            ...
            document.getElementById("edit-event-btn").innerHTML = "Modifier";
            eventClicked();
            flatPickrInit();
...
function editEvent(data) {
    ...
    if (data_id == 'new-event') {
        document.getElementById('modal-title').innerHTML = "";
        document.getElementById('modal-title').innerHTML = "Ajouter un événement";
        document.getElementById("btn-save-event").innerHTML = "Ajouter un événement";
        eventTyped();
    } else if (data_id == 'edit-event') {
        data.innerHTML = "Annuler";
        data.setAttribute("data-id", 'cancel-event');
        document.getElementById("btn-save-event").innerHTML = "Update Event";
        data.removeAttribute("hidden");
        eventTyped();
    } else {
        data.innerHTML = "Modifier";
...
function upcomingEvent(a) {
    ...
    Array.from(a).forEach(function (element) {
        ...
        if (e_dt == "Invalid Date" || e_dt == undefined) {
            ...
            const newDate = new Date(e_dt).toLocaleDateString('fr', { year: 'numeric', month: 'numeric', day: 'numeric' });
        ...
        if (startDate === "Invalid Date" || startDate === undefined) {
            ...
            const newDate = new Date(startDate).toLocaleDateString('fr', { year: 'numeric', month: 'numeric', day: 'numeric' });
...
var str_dt = function formatDate(date) {
    var monthNames = ["Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembere", "Octobre", "Novembre", "Décembre"];
    var d = new Date(date),
